...
def main():
    ...
    parser.add_argument('--output', required=True, help='Output directory for the PDF')
    ...
    tex_filename = f"Local_File_FY{fiscal_year}.tex"
    ...
    pdf_path = os.path.join(args.output, tex_filename.replace('.tex', '.pdf'))
