...
Section keys use prefixes to indicate their category. The assembly script uses these prefixes to organize sections in the dashboard and determine rendering behavior.
